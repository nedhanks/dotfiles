...
export ZSH="/Users/ned.hanks/.oh-my-zsh"
...
#__conda_setup="$('/Users/ned.hanks/opt/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    eval "$__conda_setup"
#else
#    if [ -f "/Users/ned.hanks/opt/miniconda3/etc/profile.d/conda.sh" ]; then
#        . "/Users/ned.hanks/opt/miniconda3/etc/profile.d/conda.sh"
#    else
#        export PATH="/Users/ned.hanks/opt/miniconda3/bin:$PATH"
#    fi
#fi
#unset __conda_setup
# <<< conda initialize <<<
